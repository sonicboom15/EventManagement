<?php
    // this page is used to register for new event or create an event
...
if($imgOk==1){
      ...
      $eventObject = new Event();
       ...
       // echo $user_id;
        $json_registration = $eventObject->createNewEvent($event_name,$image_file,$event_startDate,$event_endDate,$event_time,$event_desc,$category_id,$date_of_displayingpost,$venue_adr,$user_id);
